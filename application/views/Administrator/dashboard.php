...
<div class="row">
    <div class="col-md-12 col-xs-12">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-3 col-xs-6 section4">
                <div class="col-md-12 section122" style="background-color:#f39c12;"
                    onmouseover="this.style.background = '#d2d2ff'" onmouseout="this.style.background = '##e67e22'">
                    <a href="<?php echo base_url(); ?>module/LCModule">
                        <div class="logo">
            ...
            <di class="col-md-3 col-xs-6 section4">
...
<div class="row">
    <div class="col-md-12 col-xs-12">
        ...
        <div class="col-md-10">
            ...
            <?php if (array_search("lc_add", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <div class="col-md-2 col-xs-6 ">
                <div class="col-md-12 section20">
                    <a href="<?php echo base_url(); ?>lc_add">
                        <div class="logo">
                            <i class="menu-icon fa fa-usd"></i>
                        </div>
                        <div class="textModule">
            ...
            <?php endif; ?>
            <?php if (array_search("lcc_expense", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <div class="col-md-2 col-xs-6 ">
                <div class="col-md-12 section20">
                    <a href="<?php echo base_url(); ?>lcc_expense">
                        <div class="logo">
                            <i class="menu-icon fa fa-usd"></i>
                        </div>
                        <div class="textModule">
            ...
            <?php endif; ?>
            <?php if (array_search("lc_invoice", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <div class="col-md-2 col-xs-6 ">
                <div class="col-md-12 section20">
